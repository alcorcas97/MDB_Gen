...
contextBridge.exposeInMainWorld('fiberApp', {
  ...
  listOperationHistory: (payload) => ipcRenderer.invoke('history:list', payload),
  restoreOperationHistory: (payload) => ipcRenderer.invoke('history:restore', payload),
  openOperationHistoryFolder: (payload) => ipcRenderer.invoke('history:open-folder', payload),
  ...
  reextractDpCoordinates: (payload) => ipcRenderer.invoke('dwg:reextract-dp-coordinates', payload),
